...
ext_modules = [
    Extension(
        "pymt_prms_soil.lib.prmssoil",
        ["pymt_prms_soil/lib/prmssoil.pyx"],
        libraries=libraries + ["bmiprmssoil"],
        extra_objects=["pymt_prms_soil/lib/bmi_interoperability.o"],
        **common_flags
    ),
]
...
entry_points = {
    "pymt.plugins": [
        "PRMSSoil=pymt_prms_soil.bmi:PRMSSoil",
    ]
}
...
class build_ext(_build_ext):
    def run(self):
        with as_cwd("pymt_prms_soil/lib"):
...
setup(
    name="pymt_prms_soil",
    author="Community Soil Dynamics Modeling System",
    author_email="csdms@colorado.edu",
    description="PyMT plugin for pymt_prms_soil",
    long_description=long_description,
    version="0.2.0",
    url="https://github.com/pymt-lab/pymt_prms_soil",
    classifiers=[
